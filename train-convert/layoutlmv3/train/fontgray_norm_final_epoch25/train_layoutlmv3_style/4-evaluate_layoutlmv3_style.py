...
from train_layoutlmv3_style.hf_utils import decode_schema_spans, predict_pytorch


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate LayoutLMv3 font/gray style model at word/span level.")
...
def main() -> None:
    ...
    schema_spans, fragmentation = decode_schema_spans(rows, pred_labels_raw, pred_scores)
